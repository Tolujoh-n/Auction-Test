...
contract('AuctionContract', function (accounts) {
  ...
  it("Should NOT allow to bid more than remaining tokens", function() {
    ...
    ***********/
    return auctionInstance.bid(itemId=0, count=6, {from: accounts[1]})
    .then(function (result) {
      /*
  ...
  it("Should NOT allow non owner to reveal winners", function() {
    ...
    ***********/
     return auctionInstance.revealWinners(1, {from: accounts[1]})
  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
        return auctionInstance.revealWinners(itemId=0, {from: accounts[0]});
    }).then(function(result) {
      /**********
      ...
      ***********/
      assert.equal('0x00', result.receipt.status, 'winner address is not the default address');
      /**********
      TASK 16: call winners function from accounts[0] to get the winner of item id 1
      ***********/
      return auctionInstance.revealWinners(itemId=1, {from: accounts[0]});
    }).then(function(result) {
      /**********
      ...
      ***********/
      return auctionInstance.revealWinners(itemId=2, {from: accounts[3]});
    }).then(function(result) {
      /**********
